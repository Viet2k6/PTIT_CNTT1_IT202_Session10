...
VALUES ('nguyen_test', 'Nguyễn Văn Test', 'Nam', 'test_nguyen@gmail.com', '123456', '2000-01-01', 'Hà Nội');

-- Truy vấn lại view để kiểm tra
SELECT * FROM view_users_firstname;
